...
lab4reverse:
	...
	L4:	ble	s0, s1, L5
		add	t0, a0, s0		#t0 = &str[back]
		lbu	s2, (t0)		#c = str[back]
		add	t1, a0, s1  		#t1 = &str[front]
		lbu	t2, (t1)		#t2 = str[front]
		sb 	t2, (t0)		#str[back] = str[front] 
		sb	s2, (t1)		#str[front] = c
		addi	s0, s0, -1
		addi 	s1, s1, 1
		j 	L4
